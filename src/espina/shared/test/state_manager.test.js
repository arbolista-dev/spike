...
import { MOCK_STORE, MOCK_LOCALSTORAGE, MOCK_COOKIES, MOCK_PAYLOAD, MOCK_LOCATION, MOCK_ROUTES } from 'espina/shared/test/mock/config.mock';
...
export function mockSharedStateManagerBehavior() {
  describe('shared state manager behavior', () => {
    ...
    it('parseInitialLocation', () => {
      ...
      const location_state = stateManager.parseInitialLocation(MOCK_LOCATION, router);
